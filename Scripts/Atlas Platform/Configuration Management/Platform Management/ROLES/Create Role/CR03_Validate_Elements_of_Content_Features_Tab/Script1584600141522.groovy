...
not_run: WebUI.click(findTestObject('ROLES/Create Role/New Role_page/a_Content Features'))
...
not_run: WebUI.verifyElementPresent(findTestObject('ROLES/Create Role/Content Features/tickMark_ContentFeatures'), 0)

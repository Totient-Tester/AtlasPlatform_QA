...
not_run: WebUI.click(findTestObject('ROLES/Create Role/New Role_page/a_Message Features'))
...
not_run: WebUI.verifyElementPresent(findTestObject('ROLES/Create Role/Message Features/tickMark_MessageFeatures'), 0)

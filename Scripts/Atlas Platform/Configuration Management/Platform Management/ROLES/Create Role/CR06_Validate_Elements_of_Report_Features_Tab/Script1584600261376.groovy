...
not_run: WebUI.click(findTestObject('ROLES/Create Role/New Role_page/a_Report Features'))
...
not_run: WebUI.verifyElementPresent(findTestObject('ROLES/Create Role/Report Features/tickMark_ReportFeatures'), 0)

...
WebUI.verifyElementPresent(findTestObject('ROLES/Roles_page/Hamburger/a_Edit'), 0)

not_run: WebUI.verifyElementPresent(findTestObject('ROLES/Roles_page/Hamburger/a_Copy'), 0)

WebUI.verifyElementPresent(findTestObject('ROLES/Roles_page/Hamburger/a_Change Status'), 0)

not_run: WebUI.verifyElementPresent(findTestObject('ROLES/Roles_page/Hamburger/a_Delete'), 0)

...
WebUI.click(findTestObject('CONTENT/Image_Listing/column_name_created'))
...
if (!(totalOfPaginationCount.equalsIgnoreCase('Showing 0 of 0 Images'))) {
    List<WebElement> elements = WebUiCommonHelper.findWebElements(findTestObject('CONTENT/Image_Listing/created_Column_Values'), 
        0)
    ...
    if (total > 10) {
        while (total != pageValueCount) {
            ...
            elements = WebUiCommonHelper.findWebElements(findTestObject('CONTENT/Image_Listing/created_Column_Values'), 
                0)
        }
    }
}
...
if (!(totalOfPaginationCount.equalsIgnoreCase('Showing 0 of 0 Images'))) {
    List<WebElement> elements1 = WebUiCommonHelper.findWebElements(findTestObject('CONTENT/Image_Listing/created_Column_Values'), 
        0)
    ...
    if (total > 10) {
        while (total != pageValueCount1) {
            ...
            elements1 = WebUiCommonHelper.findWebElements(findTestObject('CONTENT/Image_Listing/created_Column_Values'), 
                0)
        }
    }
}

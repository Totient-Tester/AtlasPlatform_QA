...
WebUI.click(findTestObject('AUDIENCE/Data Source/archived'))

WebUI.click(findTestObject('Object Repository/AUDIENCE/Data Source/apply_btn'))

WebUI.delay(3)

WebUI.verifyElementText(findTestObject('AUDIENCE/Data Source/archive_text_filtered'), 'Archived')
...
WebUI.click(findTestObject('AUDIENCE/Data Source/archive_close_icon'))

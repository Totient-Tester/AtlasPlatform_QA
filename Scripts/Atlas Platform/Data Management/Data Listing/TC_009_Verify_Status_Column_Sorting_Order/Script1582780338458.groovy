...
WebUI.click(findTestObject('AUDIENCE/Data Source/status_Column_Name'))
...
if (!(totalOfPaginationCount.equalsIgnoreCase('Showing 0 of 0 Images'))) {
    ...
    List<WebElement> elements = WebUiCommonHelper.findWebElements(findTestObject('AUDIENCE/Data Source/status_column_values'),  0)
    ...
    if (total > 10) {
        while (total != pageValueCount) {
            ...
            elements = WebUiCommonHelper.findWebElements(findTestObject('AUDIENCE/Data Source/status_column_values'), 0)
        }
    }
}
...
if (!(totalOfPaginationCount.equalsIgnoreCase('Showing 0 of 0 Images'))) {
    List<WebElement> elements1 = WebUiCommonHelper.findWebElements(findTestObject('AUDIENCE/Data Source/status_column_values'), 
        0)
    ...
    if (total > 10) {
        while (total != pageValueCount1) {
            ...
            elements1 = WebUiCommonHelper.findWebElements(findTestObject('AUDIENCE/Data Source/status_column_values'), 0)
        }
    }
}

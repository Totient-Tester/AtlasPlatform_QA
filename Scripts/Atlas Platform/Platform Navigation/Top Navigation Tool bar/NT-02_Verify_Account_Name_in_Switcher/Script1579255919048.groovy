...
WebUI.verifyElementPresent(findTestObject('Login_Page/Dashboard/Switcher'), 0, FailureHandling.STOP_ON_FAILURE)

WebUI.verifyElementText(findTestObject('Login_Page/Dashboard/Switcher'), 'Toyota')

...
not_run: WebUI.verifyElementPresent(findTestObject('Login_Page/Page_/Email Address_clear_svg-icon'), 0, FailureHandling.CONTINUE_ON_FAILURE)

not_run: svg = WebUI.getCSSValue(findTestObject('Login_Page/Page_/Email Address_clear_svg-icon'), findTestData('Login page CSS').getValue(
        9, 1), FailureHandling.CONTINUE_ON_FAILURE)

not_run: WebUI.verifyEqual(svg, findTestData('Login page CSS').getValue(9, 6), FailureHandling.CONTINUE_ON_FAILURE)
...
not_run: svg = WebUI.getCSSValue(findTestObject('Login_Page/Page_/Password_clear_svg-icon'), findTestData('Login page CSS').getValue(
        9, 1), FailureHandling.CONTINUE_ON_FAILURE)

not_run: WebUI.verifyEqual(svg, findTestData('Login page CSS').getValue(9, 11), FailureHandling.CONTINUE_ON_FAILURE)

not_run: svg = WebUI.getCSSValue(findTestObject('Login_Page/Page_/Password lock svg icon'), findTestData('Login page CSS').getValue(
        9, 1), FailureHandling.CONTINUE_ON_FAILURE)
